...
namespace FenrirProjectManager.Controllers
{
    public partial class IssuesController
    {
        ...
        protected IssuesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IssuesController Actions { get { return MVC.Issues; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Issues";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Issues";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_IssuesController : FenrirProjectManager.Controllers.IssuesController
    {
        public T4MVC_IssuesController() : base(Dummy.Instance) { }

        [NonAction]
        partial void MyIssuesOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult MyIssues()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.MyIssues);
            MyIssuesOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Model.Models.Issue issue);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Model.Models.Issue issue)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "issue", issue);
            CreateOverride(callInfo, issue);
            return callInfo;
        }
